...
```{r}
formula <- Price_per_sqm ~ District + Total_price + Days_from_initial_announcement + Rent_imp + Ownership + Floor_binned + Construction_type + Finishing_condition + No_of_floors_binned + Property_market + Area + No_of_rooms + Building_age_binned + Heating + Lat + Lon + Distance_to_PKIN_in_km + Distance_to_subway_in_km + Distance_to_airport_in_km + Vistula_side + Life_quality + Family_friendliness + Single_people_friendliness + Senior_people_friendliness
```
